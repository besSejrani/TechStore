...
const index = () => {
  ...
  const rows = [
    ...
    {
      id: 3,
      number: "Compute Module 4 IO Board",
      customer: 30,
      method: false,
      total: false,
      status: 56,
    ...
    {
      id: 9,
      number: "Raspberry Pi Touch Display",
      customer: 55,
      method: true,
      total: false,
      status: 56,
